...
const ComprehensiveFurnitureLanding: React.FC = () => {
  ...
  const serviceCategories = [
    {
      ...
      description: 'Complete living room sets including sofas, coffee tables, and entertainment units',
      priceRange: '$2,000 - $8,000',
      duration: '2-4 weeks',
      features: ['Sofas & Sectionals', 'Coffee Tables', 'TV Units', 'Accent Chairs', 'Bookshelves', 'Side Tables'],
      popular: true,
      color: 'blue'
    },
    {
      ...
      description: 'Premium bedroom sets with beds, wardrobes, and nightstands',
      priceRange: '$1,500 - $6,000',
      duration: '2-3 weeks',
      features: ['Bed Frames', 'Mattresses', 'Wardrobes', 'Dressers', 'Nightstands', 'Mirrors'],
      popular: true,
      color: 'green'
    },
    {
      ...
      duration: '1-2 weeks',
      features: ['Office Desks', 'Ergonomic Chairs', 'File Cabinets', 'Bookcases', 'Conference Tables'],
      popular: false,
      color: 'purple'
    },
    {
      ...
      description: 'Bespoke furniture pieces tailored to your specifications',
      priceRange: '$1,000 - $10,000',
      duration: '6-12 weeks',
      features: ['Custom Design', 'Material Selection', 'Size Customization', 'Color Choices', 'Unique Styles'],
      popular: true,
      color: 'teal'
    }
  ];
  ...
  // Gallery images
  const galleryImages = [
    { id: 1, title: 'Modern Sofa Set', category: 'living-room', description: 'Contemporary living room' },
    { id: 2, title: 'King Bedroom Set', category: 'bedroom', description: 'Luxury bedroom furniture' },
    { id: 3, title: 'Executive Desk', category: 'office', description: 'Professional workspace' },
    { id: 4, title: 'Custom Dining Table', category: 'custom', description: 'Handcrafted masterpiece' },
    { id: 5, title: 'Sectional Couch', category: 'living-room', description: 'Family room furniture' },
    { id: 6, title: 'Home Office Setup', category: 'office', description: 'Complete office solution' }
  ];
  ...
  // Statistics
  const statistics = [
    { number: '10,000+', label: 'Furniture Sold', icon: <Home className="w-6 h-6" /> },
    { number: '97%', label: 'Customer Satisfaction', icon: <Star className="w-6 h-6" /> },
    { number: '100+', label: 'Furniture Styles', icon: <Sofa className="w-6 h-6" /> },
  ...
  const furnitureProducts = [
    {
      ...
      price: '$3,499',
      rating: 4.9,
      features: ['Premium Leather', '5-Year Warranty', 'Free Delivery'],
      bestSeller: true
    },
    {
      id: 2,
      ...
      price: '$2,799',
      rating: 4.8,
      features: ['King Size Bed', 'Full Wardrobe', 'Assembly Included'],
      bestSeller: true
    },
    {
      id: 3,
      ...
      price: '$1,999',
      rating: 4.7,
      features: ['Ergonomic Design', 'Cable Management', 'Premium Finish'],
      bestSeller: false
    }
  ];
  ...
  const faqItems = [
    {
      ...
      answer: 'We use premium materials including solid wood, high-grade leather, durable fabrics, and eco-friendly composites. All materials are sourced from certified suppliers ensuring quality and sustainability.'
    },
    {
      question: 'Do you offer delivery and assembly?',
      answer: 'Yes! We provide free delivery within 50 miles and professional assembly services. Our team will set up your furniture and remove all packaging materials.'
    },
    {
      question: 'What is your warranty policy?',
      answer: 'All furniture comes with a minimum 3-year warranty covering manufacturing defects. Premium items include extended warranties up to 10 years. Custom pieces have specialized warranty terms.'
    },
    {
      question: 'Can I customize furniture designs?',
      answer: 'Absolutely! Our custom furniture service allows you to choose materials, dimensions, colors, and finishes. Work directly with our designers to create unique pieces perfect for your space.'
    }
  ];
  ...
  const whyChooseUs = [
    {
      ...
      description: 'Premium materials with extended warranties'
    },
    {
    ...
    },
    {
      ...
      title: 'Fast Delivery',
      description: 'Quick turnaround with free shipping'
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                Quality Furniture
                <span className="block mt-2" style={{ color: 'rgba(255,255,255,0.8)' }}>For Every Room</span>
              </h1>
              
              <p className="text-xl mb-8 max-w-2xl opacity-95">
                Discover stunning furniture collections that combine style, comfort, and durability. 
                Transform your space with our premium selections.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 transform hover:scale-[1.02] transition-transform duration-300">
              ...
              {isSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <p style={{ color: 'var(--gray-color)' }}>We'll contact you within 2 hours with furniture options and pricing.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium mb-1" style={{ color: 'var(--gray-color)' }}>Furniture Category*</label>
                      <select
                        name="service"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2" style={{ color: 'var(--gray-color)' }}>Requirements</label>
                    <textarea
                      name="message"
                      ...
                      placeholder="Room dimensions, style preferences, budget range..."
                    />
                  </div>
      ...
      <section className="py-16" style={{ backgroundColor: 'var(--background-alt)' }}>
        <div className="max-w-[90%] mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl" style={{ color: 'var(--gray-color)' }}>
              Explore our wide range of premium furniture options
            </p>
          </div>
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <div className="flex justify-between items-center pt-6 border-t border-gray-100">
                    <div>
                      <div className="text-sm" style={{ color: 'var(--gray-color)' }}>Price Range</div>
                      <div className="text-2xl font-bold" style={{ color: 'var(--black-color)' }}>{service.priceRange}</div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm" style={{ color: 'var(--gray-color)' }}>Delivery</div>
        ...
        <div className="max-w-[90%] mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            <div>
              ...
              <p style={{ color: 'var(--gray-color)' }}>Browse our stunning furniture collections</p>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="aspect-video rounded-xl flex items-center justify-center" style={{ background: 'linear-gradient(to bottom right, rgba(0,173,181,0.2), rgba(0,173,181,0.4))' }}>
                  <div className="text-center">
                    <Sofa className="w-16 h-16 mx-auto mb-4" style={{ color: 'var(--sky-blue)' }} />
                ...
                <div>
                  <h4 className="font-bold mb-4" style={{ color: 'var(--black-color)' }}>Product Details</h4>
                  <p className="mb-6" style={{ color: 'var(--gray-color)' }}>
                    Crafted with premium materials and attention to detail, our furniture 
                    combines timeless design with modern comfort and durability.
                  </p>
                  
                  <div className="grid grid-cols-2 gap-4">
                    <div className="rounded-xl p-4" style={{ backgroundColor: 'var(--background-alt)' }}>
                      <div className="text-sm" style={{ color: 'var(--gray-color)' }}>Warranty</div>
                      <div className="text-xl font-bold" style={{ color: 'var(--black-color)' }}>5 Years</div>
                    </div>
                    <div className="rounded-xl p-4" style={{ backgroundColor: 'var(--background-alt)' }}>
                      <div className="text-sm" style={{ color: 'var(--gray-color)' }}>Delivery</div>
                      <div className="text-xl font-bold" style={{ color: 'var(--black-color)' }}>Free</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16" style={{ backgroundColor: 'var(--background-alt)' }}>
        <div className="max-w-[90%] mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl" style={{ color: 'var(--gray-color)' }}>
              Shop our most popular furniture sets
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-10 opacity-90">
              Get 10% off on your first order. Free delivery and assembly included.
            </p>
...
export default ComprehensiveFurnitureLanding;