...
interface CategoryLevelThreeItem {
  ...
  category_level3_status: number;
  category_level3_createdAt: string;
}
...
const CLThreeList: React.FC = () => {
  const navigate = useNavigate();
  const [categories, setCategories] = useState<CategoryLevelThreeItem[]>([]);
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
      <div className="p-5 lg:p-6 space-y-5">
        <DataTableFilters
          title="Category Level Three List"
          onFilterChange={handleFilterChange}
          onAddNew={canAdd ? () => navigate("/admin/category/level-three/add") : undefined}
        />
            ...
            <tbody>
              {loading ? (
                ...
                categories.map((category, idx) => {
                  ...
                  return (
                    <tr
                      key={category.category_level3_id}
                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-sm text-gray-700 dark:text-gray-300">
                        {category.category_level3_img ? (
                          <img
                            src={`${baseURL}${category.category_level3_img}`}
                            alt={category.category_level3_name}
                      ...
                      <td className="px-4 py-2 text-sm text-gray-600 dark:text-gray-400 whitespace-nowrap">
                        {formatDate(category.category_level3_createdAt)}
                      </td>
